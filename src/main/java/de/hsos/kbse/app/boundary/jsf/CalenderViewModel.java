...
@Named("calenderVM")
@ConversationScoped
public class CalenderViewModel implements Serializable {
    ...
    private boolean validateInput(ValidationGroup group) {
        ...
        Set<ConstraintViolation<CalenderViewModel>> constraintViolations = null;
        ...
        if(constraintViolations != null && constraintViolations.isEmpty()) {
            ...
            Iterator<ConstraintViolation<CalenderViewModel>> iter = constraintViolations.iterator();
            while (iter.hasNext()) {
